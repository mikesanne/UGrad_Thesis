function [v, scale_vecCam] = main(start, finish, step)  
%% Matlab code to perform relative pose estimation
% Generated by Michael Sanne SNNMIC003
% Camera-Based Pose-Estimation for a UAV
...
%     images = imageDatastore('Data/hoveringDown/imagesUndistort_hoveringDown');
%     K = load('Data/hoveringDown/camIntrinsicDown.txt')';
    
%    images = imageDatastore('Data/SFM_EDU');
%    K = [719.545900000000,0,0;0,719.545900000000,0;0,0,1];
%    cameraParams = cameraParameters('IntrinsicMatrix', K);
    
%    images = imageDatastore('Data/EURoc/mav0/cam0/data');
%    K = [458.654, 0, 0; 0, 457.296, 0; 367.215, 248.375, 1];

%     images = imageDatastore('Data/mav/input');
%     K = [572.87952, 0, 0; 0, 572.87952, 0; 390.26123, 248.79961, 1];
    cameraParams = cameraParameters('IntrinsicMatrix', K);
    ...
    if nargin < 3
        start = 1;
        finish = numel(images.Files);
        step = 1;
    end
    
    %% Import first 2 images
    I1 = rgb2gray(readimage(images,start));
    %I1 = readimage(images,1);
    I2 = rgb2gray(readimage(images,start+step));
    ...
    try
      ...
      [R, t, good, mask] = cv.recoverPose(E_12, mpoints1_12.Location(minf_12,:), mpoints2_12.Location(minf_12,:), 'CameraMatrix', K');
...
for i = start+2*step:step:finish%numel(images.Files)
    ...
    for j=1:1000
      ...
      [R, t, good, mask] = cv.recoverPose(E_23, mpoints2_23.Location(minf_23,:), mpoints3_23.Location(minf_23,:), 'CameraMatrix', K');
      [orient_23,loc_23,vpf_23] = relativeCameraPose(E_23, cameraParams, mpoints2_23(minf_23), mpoints3_23(minf_23));
      [R_c, t_c] = recoverCameraMat(E_23, mpoints2_23.Location(1,:), mpoints3_23.Location(1,:))
    ...
    scale = C1/C2;
    scale_vecCam = [scale_vecCam scale];
...
%     end
    ...
    Plot3D(R1_12, t1_12, R2_12, t2_12, R2_12, t2_12, R3_23, t3_23, cameraParams, points1_123, points2_123, points2b_123, points3_123, '/Users/michaelsanne/Documents/UCT/4th Year/Theses/Thesis Write-up/figures/With_BadScale_Before_Scaling');
    R2_23 = R2_12;
    t2_23 = t2_12;
    P2_23 = cameraMatrix(cameraParams, R2_23, t2_23);
...
Plot3D(R1_12, t1_12, R2_12, t2_12, R2_12, t2_12, R3_23, t3_23, cameraParams, points1_123, points2_123, points2b_123, points3_123, '/Users/michaelsanne/Documents/UCT/4th Year/Theses/Thesis Write-up/figures/With_BadScale_After_Scaling');
Plot(v);
...
%     pcsize = 0.5;
%     a = plotCamera('Size', pcsize, 'Location', t1_12, 'Orientation', R1_12, 'Color', 'b', 'Opacity', 0);
%     b = plotCamera('Size', pcsize, 'Location', t2_23, 'Orientation', R2_23, 'Color', 'g', 'Opacity', 0);
%     c = plotCamera('Size', pcsize, 'Location', t3_23, 'Orientation', R3_23, 'Color', 'r', 'Opacity', 0);
