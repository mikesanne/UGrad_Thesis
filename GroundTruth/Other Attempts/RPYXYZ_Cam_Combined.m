...
%  Estimate the essential matrix
  ...
  % Camera pose
  [R2, t2, good, mask] = cv.recoverPose(E, mpoints1.Location, mpoints2.Location, 'CameraMatrix', K');
  mask = logical(mask);  
 vpf = good/size(mpairs,1);
...
R2 = R2';
t2=t2';
mpairs = mpairs(mask,:); mpoints1 = mpoints1(mask,:); mpoints2 = mpoints2(mask,:);
